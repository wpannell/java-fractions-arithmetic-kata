...
public class FractionMultiplicationShouldBe {
  ...
  public void zeroWhenAnyFractionIsZero() {
    assertThat("0/13 * 0/7 = 0",
        new Fraction(0, 13).times(new Fraction(0, 7)),
        is(equalTo(Fraction.ZERO)));

    assertThat("0/13 * 3/7 = 0",
        new Fraction(0, 13).times(new Fraction(3, 7)),
        is(equalTo(Fraction.ZERO)));
  }

  @Test
  public void theFractionWhenItIsMultipliedByIdentity() {
    assertThat("3/13 * 7/7 = 3/13",
        new Fraction(3, 13).times(new Fraction(7, 7)),
        is(equalTo(new Fraction(3, 13))));
  }

  @Test
  public void theProductAcrossTheNumeratorsAndDenominators() {
    assertThat("3/13 * 12/7 = 36/91",
        new Fraction(3, 13).times(new Fraction(12, 7)),
        is(equalTo(new Fraction(36, 91))));
    ...
    assertThat("-3/13 * 12/7 = -(36/91)",
        new Fraction(-3,13).times(new Fraction(12,7)),
        is(equalTo(new Fraction(36, 91).negate())));
